...
container
  .bind<BattleService>(SERVICE_IDENTIFIER.BATTLE_SERVICE)
  .to(BattleServiceImpl)
container
  .bind<CartridgesService>(SERVICE_IDENTIFIER.CARTRIDGES_SERVICE)
  .to(CartridgesServiceImpl)
  .inSingletonScope()
container
  .bind<DefendersService>(SERVICE_IDENTIFIER.DEFENDERS_SERVICE)
  .to(DefendersServiceImpl)
  .inSingletonScope()
container
  .bind<EnemiesService>(SERVICE_IDENTIFIER.ENEMIES_SERVICE)
  .to(EnemiesServiceImpl)
  .inSingletonScope()
container
  .bind<BonusService>(SERVICE_IDENTIFIER.BONUS_SERVICE)
  .to(BonusServiceImpl)
